...
let boxInformation= document.getElementById("box-information");
    ...
    .then(data => {
        ...
        data.forEach(comida => {
            html += `
                 ...
                 <h3>${comida.title}</h3>
                 <p>${comida.precio}</p>
                 <a class="btn recipe-btn" id="btn-info" href="#" data-id="${comida.id}">Más Información</a>
            ...
            <h1>${comida.title}</h1>
            <img src="${comida.thumbnailUrl}" alt="">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste ducimus consequatur necessitatibus atque, provident minus. Mollitia, ipsa. Recusandae, porro eaque?
                 </p>
        ...
        menu.innerHTML = html;
        boxInformation.innerHTML = html_informacion;
...
let boxInfo = document.getElementById('box-information');
    ...
    let html =`
        <div class="meal-details-content" id="meal-details-content>
            <div class="recipe-instruct">
                ...
                <h2>Detalles:</h2>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem ipsa, animi quam debitis nulla, consectetur exercitationem architecto ducimus placeat harum iusto, similique commodi itaque quas? Veniam consequuntur soluta corrupti asperiores.</p>
            </div>
            <div class="recipe-meal-img">
                <img src="${meal.thumbnailUrl}" alt="/">
            </div>
        </div>
    `;
    boxInfo.innerHTML = html;
    boxInfo.classList.toggle('showRecipe');
}
...
function setInformation(objeto) {
